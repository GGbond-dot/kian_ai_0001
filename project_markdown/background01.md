...
- LLM（Tier 2，coder-next）：https://coding.dashscope.aliyuncs.com/v1 + `${DASHSCOPE_CODING_API_KEY}` + model qwen3-coder-next
- LLM_FAST（Tier 1，flash）：https://dashscope.aliyuncs.com/compatible-mode/v1 + `${DASHSCOPE_API_KEY}` + model qwen-flash
